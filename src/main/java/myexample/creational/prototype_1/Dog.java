package myexample.creational.prototype_1;
...
public class Dog implements Animal {
	...
	public Dog(String name, int age, String color, Dogleg dogleg,
			Dogtail dogtail, Dogear dogear, Dogeye dogeye) {
		super();
		this.name = name;
		this.age = age;
		this.color = color;
	...
	public String toString() {
		return "Dog [name=" + name + ", age=" + age + ", color=" + color
				+ ", dogleg=" + dogleg + ", dogtail=" + dogtail + ", dogear="
				+ dogear + ", dogeye=" + dogeye + "]";
	}
