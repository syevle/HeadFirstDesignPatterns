...
/*
		...
		Color: Blue has been applied to myexample.structural.decorator_5.Circle@3cd1a2f1

		Create Blue color Rectangle using BlueShapeDecorator
		Shape: Rectangle has been drawn
		Color: Blue has been applied to myexample.structural.decorator_5.Rectangle@2f0e140b
