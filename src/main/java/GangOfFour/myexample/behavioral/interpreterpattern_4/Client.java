package GangOfFour.myexample.behavioral.interpreterpattern_4;
...
public class Client {
	...
	public static void main(String[] args) {
		...
		System.out
				.println("Please select the Expression  : 'MM-DD-YYYY' or 'YYYY-MM-DD'");
		...
		System.out.println("Input : " + context.getExpression() + " : "
				+ new Date());
