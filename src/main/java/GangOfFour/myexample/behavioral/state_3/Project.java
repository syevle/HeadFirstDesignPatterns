...
public class Project implements ProjectState {
	...
	public void doRequirmentGathering() {
		...
		/*
		 * Once RequirmentGathering is finished project internal state will be
		 * moved to DesignAndArchitectureState
		 */
	...
	public void doDesignAndArchitecture() {
		...
		/*
		 * Once DesignAndArchitecture is finished project internal state will be
		 * moved to DevelopementState
		 */
	...
	public void doDevelopement() {
		...
		/*
		 * Once Developement is finished project internal state will be moved to
		 * TestingState
		 */
