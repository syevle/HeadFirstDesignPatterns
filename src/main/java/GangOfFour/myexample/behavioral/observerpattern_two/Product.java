package GangOfFour.myexample.behavioral.observerpattern_two;
...
public class Product implements Subject {
	...
	public void setAvailability(String availability) {
		this.availability = availability;
		System.out
				.println("Availability changed from Not available to Available");
		notifyObservers();
	}
	...
	public void notifyObservers() {
		System.out.println("Product Name :" + this.getProductName()
				+ ", Product Type : " + this.productType + ", product Price : "
				+ this.productPrice
