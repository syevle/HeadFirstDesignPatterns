...
public class David implements EnglishSpeaker {
	...
	public static void main(String args[]) {
		...
		System.out
				.println("Reply From Rohit [French Speaker can Speak and Understand only French] :  "
						+ replyFromRohit);
	}
	...
	public String askQuestion(String words) {
		System.out
				.println("Question Asked by David [English Speaker and Can understand only English] : "
						+ words);
		ITarget target = new John();
		String replyFromRohit = target.translateAndTellToOtherPerson(words,
				"French");
